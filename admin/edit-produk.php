            ...
            if (!empty($_FILES["nama_file"]["tmp_name"])) {
              ...
              if ($jenis_gambar == "image/jpeg" || $jenis_gambar == "image/jpg" || $jenis_gambar == "image/gif" || $jenis_gambar == "image/x-png") {
                ...
                if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
                  $sql = "UPDATE produk SET nama='$nama', jenis='$jenis', harga='$harga', keterangan='$keterangan', stok='$stok' WHERE kode='$kode'" or die(mysqli_error($koneksi));
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <select id="jenis" name="jenis" value="<?php echo $row['jenis']; ?>" class="form-control" required>
                            <option value="Makanan">Biji Kopi</option>
                            <option value="Minuman">Bubuk Kopi</option>
                            <option value="Camilan">Olahan Kopi</option>
                          </select>
