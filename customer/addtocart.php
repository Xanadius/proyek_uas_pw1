...
if (empty($_SESSION['username'])) {
  ...
  if (isset($_GET['kd'])) {
    ...
    if ($stock == 0) {
      ...
      $insert = mysqli_query($koneksi, "INSERT INTO cart(id_cart, tanggal, kode, nama, harga, qty, jumlah, sesi) VALUES('$nomor', '$tanggal', '$kode', '$nama', '$harga', '$qty', '$jumlah', '$sesi');") or die(mysqli_error($koneksi));
