                  ...
                  <div class="form-panel">
                    <form class="form-horizontal style-form" action="update-po-terima.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input name="no_po" type="text" id="no_po" value="<?php echo $row['no_po']; ?>" class="form-control" autocomplete="off" readonly="readonly" />
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <select id="Berat" name="Berat" class="form-control" required>
                            ...
                            <option value="M">750 g</option>
                            <option value="L">1 Kg</option>
                            <option value="XL">2,5 Kg</option>
                            <option value="XXL">5 Kg</option>
                            <option value="XXXL">10 Kg</option>
                          </select>
                        </div>
                        <label class="col-sm-2 col-sm-2 control-label">Berat Sebelumnya</label>
                        <div class="col-sm-3">
                          <span class="label label-warning"><?php echo $row['berat']; ?></span>
                        </div>
                      </div>
