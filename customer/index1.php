                    ...
                    while ($data1 = mysqli_fetch_array($hasil1)) { ?>
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <center><?php echo $data1['pw']; ?></center>
                          </td>
                          <td>
                            <center>
                              <div id="thanks"><a class="btn btn-sm btn-warning" data-placement="bottom" data-toggle="tooltip" title="Detail Customer" href="detail-customer.php?hal=edit&kd_cus=<?php echo $data1['kd_cus']; ?>"><span class="glyphicon glyphicon-search"></span></a>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="panel panel-danger">
                ...
                <div class="panel-body">
                  ...
                  $hasil = mysqli_query($koneksi, $query1) or die(mysqli_error($koneksi));
                  ?>
                  <table id="example" class="table table-hover table-bordered">
                    <thead>
                      <tr>
                    ...
                    while ($data = mysqli_fetch_array($hasil)) { ?>
                      <tbody>
                        ...
                        <td>
                          <center><?php echo $data['no_po']; ?></center>
                        </td>
                        <td>
                        ...
                        <td>
                          <center>
                            <div id="thanks"><a class="btn btn-sm btn-danger" data-placement="bottom" data-toggle="tooltip" title="Cetak Invoice" href="cetak-po.php?hal=cetak&kd=<?php echo $data['no_po']; ?>"><span class="glyphicon glyphicon-print"></span></a>
              ...
              <table id="example" class="table table-hover table-bordered">
                ...
                while ($data2 = mysqli_fetch_array($hasil2)) { ?>
                  <tbody>
                    ...
                    <td>
                      <center><?php echo $data2['no_po']; ?></center>
                    </td>
                    <td>
                      <center><?php echo $data2['kd_cus']; ?></center>
                    </td>
                    <td>
                      <center><?php echo $data2['bayar_via']; ?></center>
                    </td>
                    <td>
                    ...
                    <td>
                      <center>
                        <div id="thanks"><a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Detail Pembayaran" href="detail-konfirmasi.php?hal=detail&kd=<?php echo $data2['id_kon']; ?>"><span class="glyphicon glyphicon-search"></span></a>
